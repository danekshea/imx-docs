...
Currently, the C# Core SDK provides ***read-only*** functionality. The endpoints supported are (from [this Changelog entry](https://github.com/immutable/imx-core-sdk-csharp/blob/main/CHANGELOG.md#010---2023-01-31)):
* Assets: Get & List
* Balances: Get & List
